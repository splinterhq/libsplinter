...
- [Rust](rust.md) — identical to the C build.
- [TypeScript (Deno / Bun)](typescript.md) — Deno FFI / Bun FFI.
- [Python 3](python.md) — native ctypes.
- [Java (Panama)](java.md) — the Foreign Function & Memory API.
- [Lua](lua.md) — via the Splinter `lua` command and FFI.
- [POSIX Shell / Bash](shell.md) — driving the CLI from scripts.

## See Also

- [API reference index](../api/index.md) — the C functions these bindings wrap.
- [CLI reference index](../cli/index.md) — the `splinter_cli` / `splinterctl` commands.
