...
Splinter acts as a ringless, compute-less hypervisor where inference and governance swim in adjacent lanes in the same mediated, lock-free pool.
...
Splinter is expected to be 100% operational (but still needing documentation) by mid-May to early june. Further development is not planned after 1.2.0.